...
module namespace wqnwateruse = 'http://converters.eionet.europa.eu/wise/waterQuantity/waterUse';
...
declare variable $wqnwateruse:TABLE-ID := "9447";

declare function wqnwateruse:run-checks($sourceUrl as xs:string)
as element(div)
{
    let $dataDoc := doc($sourceUrl)/*:WaterUse
    let $model := meta:get-table-metadata($wqnwateruse:TABLE-ID)
    ...
    return wqnwateruse:run-checks($dataDoc, $model, $envelope, $vocabularySpatialUnits, $dataFlowCycles, $limitDefinitions)
};

declare function wqnwateruse:run-checks(
    $dataDoc as element()*,
...
as element(div)
{
    let $qcs := wqnwateruse:getQcMetadata($model, $envelope, $dataFlowCycles)
    let $dataRows := data:get-rows($dataDoc)
    let $qcResultsMarkup := 
        <div>
            { wqnwateruse:_run-mandatory-field-qc($qcs/qc[@id="qc1"], $model, $dataRows) }
            { wqnwateruse:_run-duplicate-rows-qc($qcs/qc[@id="qc2"], $model, $dataRows) }
            { wqnwateruse:_run-data-types-qc($qcs/qc[@id="qc3"], $model, $dataRows) }
            { wqnwateruse:_run-codelists-qc($qcs/qc[@id="qc4"], $model, $dataRows) }
            { wqnwateruse:_run-spatial-unit-id-format-qc($qcs/qc[@id="qc5a"], $model, $envelope, $dataRows) }
            { wqnwateruse:_run-spatial-unit-id-reference-qc($qcs/qc[@id="qc5b"], $model, $vocabularySpatialUnits, $dataRows) }
            { wqnwateruse:_run-spatial-unit-id-scheme-qc($qcs/qc[@id="qc6"], $model, $dataRows) }
            { wqnwateruse:_run-time-reference-period-qc($qcs/qc[@id="qc7"], $model, $dataFlowCycles, $dataRows) }
            { wqnwateruse:_run-time-period-volume-sum-qc($qcs/qc[@id="qc8"], $model, $dataRows) }
            { wqnwateruse:_run-9-01-qc($qcs/qc[@id="qc9a"], $model, $dataRows) }
            { wqnwateruse:_run-9-02-qc($qcs/qc[@id="qc9b"], $model, $dataRows) }
            { wqnwateruse:_run-9-03-qc($qcs/qc[@id="qc9c"], $model, $dataRows) }
            { wqnwateruse:_run-observed-volume-limits-qc($qcs/qc[@id="qc10"], $model, $limitDefinitions, $dataRows) }
        </div>
    return 
        <div class="feedbacktext"> 
            ...
            { html:getJavascript() }
            <div>
                { uiutil:build-header-and-menu-markup("WISE SoE - Water Quantity", "Water Use", $qcs, $qcResultsMarkup) }
                { $qcResultsMarkup }
            </div>
        </div>
};

declare function wqnwateruse:getQcMetadata(
    $model as element(model),
    $envelope as element(envelope),
    $dataFlowCycles as element(DataFlows)
)
...
{
    <qcs>
        { wqnwateruse:_get-mandatory-qc-metadata($model) }
        { wqnwateruse:_get-duplicate-rows-qc-metadata($model) }
        { wqnwateruse:_get-data-types-qc-metadata($model) }
        { wqnwateruse:_get-codelists-qc-metadata($model) }
        { wqnwateruse:_get-spatial-unit-id-format-qc-metadata($envelope) }
        { wqnwateruse:_get-spatial-unit-id-reference-qc-metadata() }
        { wqnwateruse:_get-spatial-unit-id-scheme-qc-metadata() }
        { wqnwateruse:_get-time-reference-period-qc-metadata($dataFlowCycles) }
        { wqnwateruse:_get-time-period-volume-sum-qc-metadata() }
        { wqnwateruse:_get-9-01-qc-metadata() }
        { wqnwateruse:_get-9-02-qc-metadata() }
        { wqnwateruse:_get-9-03-qc-metadata() }
        { wqnwateruse:_get-observed-volume-limits-qc-metadata() }
    </qcs>
};

declare function wqnwateruse:_get-mandatory-qc-metadata($model as element(model))
as element(qc)
{
...
declare function wqnwateruse:_get-duplicate-rows-qc-metadata($model as element(model))
as element(qc)
{
...
declare function wqnwateruse:_get-data-types-qc-metadata($model as element(model))
as element(qc)
{
    <qc id="qc3">
...
declare function wqnwateruse:_get-codelists-qc-metadata($model as element(model))
as element(qc)
{
    ...
    return
        <qc id="qc4">
            ...
            <codelistUrls>
                ...
                <url columnName="observedProperty" value="http://dd.eionet.europa.eu/fixedvalues/elem/84133" />
                <url columnName="resultObservationStatus" value="http://dd.eionet.europa.eu/fixedvalues/elem/77669" />
            </codelistUrls>
        </qc>
};

declare function wqnwateruse:_get-spatial-unit-id-format-qc-metadata($envelope as element(envelope))
as element(qc)
{
...
declare function wqnwateruse:_get-spatial-unit-id-reference-qc-metadata()
as element(qc)
{
    <qc id="qc5b">
...
declare function wqnwateruse:_get-spatial-unit-id-scheme-qc-metadata()
as element(qc)
{
    <qc id="qc6">
...
declare function wqnwateruse:_get-time-reference-period-qc-metadata($dataFlowCycles as element(DataFlows))
as element(qc)
{
...
declare function wqnwateruse:_get-time-period-volume-sum-qc-metadata()
as element(qc)
{
    <qc id="qc8">
...
declare function wqnwateruse:_get-9-01-qc-metadata()
as element(qc)
{
    <qc id="qc9a">
         <caption>
            9.1 Parameter volume mathematical relation rules test - total water use for agriculture (NACE A), water use for irrigation (NACE A 01.1, 01.3)
        </caption>
        <description>
            Tested whether the WU_NACE_A volume value isn't lower than WU_NACE_A011_A013 volume value reported from the same spatial unit and time period.
        </description>
        <onSuccess>
            <message>OK - data passed the test.</message>
        </onSuccess>
        <onBlocker>
            <message>
                BLOCKER - some of the reported WU_NACE_A011_A013 volume values exceed the corresponding WU_NACE_A volume values.
            </message>
        </onBlocker>
    </qc>
};

declare function wqnwateruse:_get-9-02-qc-metadata()
as element(qc)
{
    <qc id="qc9b">
         <caption>
            9.2 Parameter volume mathematical relation rules test - total water use for manufacturing, (NACE C) water use for manufacturing cooling (NACE C Cooling)
        </caption>
        <description>
            Tested whether the WU_NACE_C volume value isn't lower than WU_NACE_C_CL volume value reported from the same spatial unit and time period.
        </description>
        <onSuccess>
            <message>OK - data passed the test.</message>
        </onSuccess>
        <onBlocker>
            <message>
                BLOCKER - some of the reported WU_NACE_C_CL volume values exceed the corresponding WU_NACE_C volume values.
            </message>
        </onBlocker>
    </qc>
};

declare function wqnwateruse:_get-9-03-qc-metadata()
as element(qc)
{
    <qc id="qc9c">
         <caption>
            9.3 Parameter volume mathematical relation rules test - total water use for NACE D, water use for electricity production cooling (NACE D Cooling)
        </caption>
        <description>
            Tested whether the WU_NACE_D volume value isn't lower than WU_NACE_D_CL volume value reported from the same spatial unit and time period.
        </description>
        <onSuccess>
            <message>OK - data passed the test.</message>
        </onSuccess>
        <onBlocker>
            <message>
                BLOCKER - some of the reported WU_NACE_D_CL volume values exceed the corresponding WU_NACE_D volume values.
            </message>
        </onBlocker>
    </qc>
};

declare function wqnwateruse:_get-observed-volume-limits-qc-metadata()
as element(qc)
{
    <qc id="qc10">
...
declare function wqnwateruse:_run-mandatory-field-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $mandatoryColumns := meta:get-mandatory-columns($model)
...
declare function wqnwateruse:_run-duplicate-rows-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $keyColumns := meta:get-primary-key-columns($model)
...
declare function wqnwateruse:_run-data-types-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function wqnwateruse:_run-codelists-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $columnsToDisplay := $model/columns/column
...
declare function wqnwateruse:_run-spatial-unit-id-format-qc($qc as element(qc), $model as element(model), $envelope as element(envelope), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function wqnwateruse:_run-spatial-unit-id-reference-qc(
    $qc as element(qc), 
    $model as element(model), 
    $vocabularySpatialUnits as element(), 
...
declare function wqnwateruse:_run-spatial-unit-id-scheme-qc(
    $qc as element(qc),
    $model as element(model),
    $dataRows as element(dataRow)*
)
...
declare function wqnwateruse:_run-time-reference-period-qc(
    $qc as element(qc), 
    $model as element(model),
    $dataFlowCycles as element(DataFlows),
    $dataRows as element(dataRow)*
...
declare function wqnwateruse:_run-time-period-volume-sum-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function wqnwateruse:_run-result-observed-value-sums-qc(
    $qc as element(qc), 
    $model as element(model),
...
declare function wqnwateruse:_run-9-01-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $allowableParameterValues := ("WU_NACE_A011_A013")
    let $totalParameterValue := "WU_NACE_A"
    return wqnwateruse:_run-result-observed-value-sums-qc($qc, $model, $allowableParameterValues, $totalParameterValue, $dataRows)
};

declare function wqnwateruse:_run-9-02-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $allowableParameterValues := ("WU_NACE_C_CL")
    let $totalParameterValue := "WU_NACE_C"
    return wqnwateruse:_run-result-observed-value-sums-qc($qc, $model, $allowableParameterValues, $totalParameterValue, $dataRows)
};

declare function wqnwateruse:_run-9-03-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $allowableParameterValues := ("WU_NACE_D_CL")
    let $totalParameterValue := "WU_NACE_D"
    return wqnwateruse:_run-result-observed-value-sums-qc($qc, $model, $allowableParameterValues, $totalParameterValue, $dataRows)
};

declare function wqnwateruse:_run-observed-volume-limits-qc(
    $qc as element(qc), 
    $model as element(model),
    $limitDefinitions as element(WiseSoeQc),
    $dataRows as element(dataRow)*
...
as element(div)
{
    let $limitsList := vldvallim:get-limits($limitDefinitions, "WISE-SoE_WaterQuantity", "WaterUse")
    ...
    let $infoColumnUrl := "http://dd.eionet.europa.eu/dataelements/84133"
    let $columnsToDisplay := $model/columns/column
