...
module namespace uiwqlmdismpsdate = 'http://converters.eionet.europa.eu/wise/waterQualityMarine/disaggregatedData/ui/samplingDate';
...
declare function uiwqlmdismpsdate:build-sampling-date-qc-markup(
    $qc as element(qc),
