...
module namespace biobioeqrcp = 'http://converters.eionet.europa.eu/wise/biology/biologyEqrClassificationProcedure';
...
import module namespace vldwqlbioeqrcpbvmath = 'http://converters.eionet.europa.eu/wise/biology/biologyEqrClassificationProcedure/validators/boundaryValuesMathRules' at './validators/vld-boundary-values-mathematical.xquery';
...
import module namespace uiwqlbioeqrcpbvmath = 'http://converters.eionet.europa.eu/wise/biology/biologyEqrClassificationProcedure/ui/boundaryValuesMathRules' at './ui/ui-boundary-values-mathematical.xquery';

declare variable $biobioeqrcp:TABLE-ID := "11116";

declare function biobioeqrcp:run-checks($sourceUrl as xs:string)
as element(div)
{
    let $fullDoc := doc($sourceUrl)
    let $dataDoc := $fullDoc/*:BiologyEQRClassificationProcedure

    let $model := meta:get-table-metadata($biobioeqrcp:TABLE-ID)
    ...
    return biobioeqrcp:run-checks($dataDoc, $model, $envelope, $vocabularyObservedPropertyBiologyEQR)
};

declare function biobioeqrcp:run-checks(
    $dataDoc as element()*,
...
as element(div)
{
    let $qcs := biobioeqrcp:getQcMetadata($model, $envelope)
    let $dataRows := data:get-rows($dataDoc)
    let $qcResultsMarkup := 
        <div>
            { biobioeqrcp:_run-mandatory-field-qc($qcs/qc[@id="wqlbioeqrcpqc1"], $model, $dataRows) }
            { biobioeqrcp:_run-duplicate-rows-qc($qcs/qc[@id="wqlbioeqrcpqc2"], $model, $dataRows) }
            { biobioeqrcp:_run-data-types-qc($qcs/qc[@id="wqlbioeqrcpqc3"], $model, $dataRows) }
            { biobioeqrcp:_run-codelists-qc($qcs/qc[@id="wqlbioeqrcpqc4"], $model, $dataRows) }
            { biobioeqrcp:_run-country-code-qc($qcs/qc[@id="wqlbioeqrcpqc5"], $model, $envelope, $dataRows) }
            { biobioeqrcp:_run-water-body-category-qc($qcs/qc[@id="wqlbioeqrcpqc6"], $model, $dataRows) }
            { biobioeqrcp:_run-determinands-and-water-body-category-qc($qcs/qc[@id="wqlbioeqrcpqc7"], $model, $vocabularyObservedPropertyBiologyEQR, $dataRows) }
            { biobioeqrcp:_run-boundary-values-math-rules-qc($qcs/qc[@id="wqlbioeqrcpqc8"], $model, $dataRows) }
        </div>
    return 
            ...
            <div>
                { 
                    uiutil:build-header-and-menu-markup(
                        "WISE SoE - Biology in transitional and coastal waters",
                        "Biology EQR Classification procedure",
                        $qcs, $qcResultsMarkup
                    ) 
                }
                { $qcResultsMarkup }
...
declare function biobioeqrcp:getQcMetadata($model as element(model), $envelope as element(envelope))
as element(qcs)
{
    <qcs>
        { biobioeqrcp:_get-mandatory-qc-metadata($model) }
        { biobioeqrcp:_get-duplicate-rows-qc-metadata($model) }
        { biobioeqrcp:_get-data-types-qc-metadata($model) }
        { biobioeqrcp:_get-codelists-qc-metadata($model) }
        { biobioeqrcp:_get-country-code-qc-metadata($envelope) }
        { biobioeqrcp:_get-water-body-category-qc-metadata() }
        { biobioeqrcp:_get-determinands-and-water-body-category-qc-metadata() }
        { biobioeqrcp:_get-boundary-values-math-rules-qc-metadata() }
    </qcs>
};

declare function biobioeqrcp:_get-mandatory-qc-metadata($model as element(model))
as element(qc)
{
...
declare function biobioeqrcp:_get-data-types-qc-metadata($model as element(model))
as element(qc)
{
    <qc id="wqlbioeqrcpqc3">
...
declare function biobioeqrcp:_get-codelists-qc-metadata($model as element(model))
as element(qc)
{
...
declare function biobioeqrcp:_get-country-code-qc-metadata($envelope as element(envelope))
as element(qc)
{
    <qc id="wqlbioeqrcpqc5">
...
declare function biobioeqrcp:_get-water-body-category-qc-metadata()
as element(qc)
{
    <qc id="wqlbioeqrcpqc6">
...
declare function biobioeqrcp:_get-determinands-and-water-body-category-qc-metadata()
as element(qc)
{
    <qc id="wqlbioeqrcpqc7">
...
declare function biobioeqrcp:_get-boundary-values-math-rules-qc-metadata()
as element(qc)
{
    <qc id="wqlbioeqrcpqc8">
...
declare function biobioeqrcp:_run-mandatory-field-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function biobioeqrcp:_run-duplicate-rows-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $keyColumns := meta:get-primary-key-columns($model)
...
declare function biobioeqrcp:_run-data-types-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function biobioeqrcp:_run-codelists-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $columnsToDisplay := $model/columns/column
...
declare function biobioeqrcp:_run-country-code-qc($qc as element(qc), $model as element(model), $envelope as element(envelope), $dataRows as element(dataRow)*)
as element(div)
{
...
declare function biobioeqrcp:_run-water-body-category-qc(
    $qc as element(qc), 
    $model as element(model), 
...
declare function biobioeqrcp:_run-determinands-and-water-body-category-qc(
    $qc as element(qc), 
    $model as element(model),
    $vocabularyObservedPropertyBiologyEQR as element(),
    $dataRows as element(dataRow)*
...
declare function biobioeqrcp:_run-boundary-values-math-rules-qc($qc as element(qc), $model as element(model), $dataRows as element(dataRow)*)
as element(div)
{
    let $columnsToDisplay := $model/columns/column
